...
export const METADATA_DESIGN_TYPE            = 'design:type';

/** Octavo */
export const METADATA_ANNOTATION_NAME        = 'octavo:annotationname';
export const METADATA_INJECTION_TYPE         = 'octavo:injectiontype';
